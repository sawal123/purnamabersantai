        ...
        <main>
            ...
            <section class="relative z-10 pb-24">
                <div class="mx-auto max-w-5xl px-5 text-center lg:px-8">
                    <div class="reveal rounded-[1.75rem] border border-[#fff700]/30 bg-[#2f2e2e]/65 px-6 py-8 shadow-[0_18px_48px_rgba(0,0,0,0.28)]">
                        ...
                        <div class="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
                            <a href="{{ route('landing.contact') }}" class="rounded-2xl bg-ember px-7 py-3 font-display text-3xl uppercase tracking-[0.08em] text-white transition hover:-translate-y-1 hover:bg-[#fff700] hover:text-[#2f2e2e]" wire:navigate>Contact Ticketing</a>
                            <a href="{{ route('landing.about') }}" class="rounded-2xl border-2 border-[#fff700] px-7 py-3 font-display text-3xl uppercase tracking-[0.08em] text-[#fff700] transition hover:-translate-y-1 hover:bg-[#fff700] hover:text-[#2f2e2e]" wire:navigate>About Festival</a>
                        </div>
                    </div>
                </div>
            </section>
